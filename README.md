...
Solution:
Added a flexible and scalable solution to the problem. Adding new Suppliers would require to only add their service.

Added Dummy Data Service for ToughJet and CrazyAir suppliers.

Added Unit Test for testing major functionalities.

Implementation took around 2 hours . Then spent some time on refactoring code.
